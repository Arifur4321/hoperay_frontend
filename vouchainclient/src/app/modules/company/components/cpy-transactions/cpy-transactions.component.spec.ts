...
import { CpyTransactionsComponent } from './cpy-transactions.component';
...
describe('CpyTransactionsComponent', () => {
  let component: CpyTransactionsComponent;
  let fixture: ComponentFixture<CpyTransactionsComponent>;
  let helper: Helper;
  let transactionsService: TransactionsService;
  let translate: TranslateTestingUtility<CpyTransactionsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [CpyTransactionsComponent],
      imports: [imports,
        NgxPaginationModule,
      ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CpyTransactionsComponent);
  ...
  describe('showTransactionDetails', () => {
    ...
    beforeEach(() => {
      ...
      modal = fixture.debugElement.query(By.css('#cpy-transactions-modal-transaction-detail'));
    });
    ...
    it('details modal should have only one table when transaction type is ACV', fakeAsync(() => {
      trc.trcType = "ACV";
      component.showTransactionDetails(trc);
      tick(100);
      fixture.detectChanges();
    ...
    it('modals should have two tables when transaction type is ALL', fakeAsync(() => {
      trc.trcType = "ALL";
      spyOn(component, 'getTransactionRecipient');
      component.transactionRecipient = helper.createEmployeeArray(1)[0];
      component.showTransactionDetails(trc);
      tick(100);
      fixture.detectChanges();
      let tables = modal.queryAll(By.css('table'));
